#ifndef HHKinFitMasterSingleHiggsSoftLimitsPS_H
#define HHKinFitMasterSingleHiggsSoftLimitsPS_H
...
class HHKinFitMasterSingleHiggsSoftLimitsPS{
  public:
  HHKinFitMasterSingleHiggsSoftLimitsPS(TLorentzVector const& tauvis1,
