...
then
    ...
    export LD_LIBRARY_PATH=$KINFIT2PATH/HHKinFit2/HHKinFit2Core:$LD_LIBRARY_PATH
    export LD_LIBRARY_PATH=$KINFIT2PATH/HHKinFit2/HHKinFit2Scenarios:$LD_LIBRARY_PATH
